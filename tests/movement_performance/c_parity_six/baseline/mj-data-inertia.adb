         ...
         begin
            ...
            for A in reverse 0 .. Diag - 1 loop
               ...
               begin
                  ...
                  SK.Add_Row
                    (D.Scratch.Ancestor_Factor (Target .. Target + A),
                     D.Scratch.Ancestor_Factor (First .. First + A), Multiplier, Accepted);
      ...
      for I in 0 .. N - 1 loop
         ...
         begin
            ...
            for A in 0 .. Diag - 1 loop
               ...
               Value := SK.Add_Product
                 (Sum, D.Scratch.Ancestor_Factor (First + A),
                  D.Scratch.Solution ((if Diag = I then A else AR.Column (D.Ancestors, I, A))));
               if not Within_Work (Value) then return; end if;
               Sum := Value;
            end loop;
