#!/usr/bin/env python3
"""Build a checked probe injecting invalid mutable data and checking phase-guard equivalence."""
import argparse
import hashlib
import json
import os
