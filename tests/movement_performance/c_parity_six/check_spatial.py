#!/usr/bin/env python3
"""Build a checked probe checking shared spatial RNE, Cartesian fallback and retry."""
import argparse
import hashlib
import json
import os
