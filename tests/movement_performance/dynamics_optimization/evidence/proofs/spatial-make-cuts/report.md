...
Source snapshot: `/tmp/sparkling-smooth-fragments-ge9ro4jw/source`

| Subprogram | Location | Result | Proof checks | Unproved/flow | Errors | Seconds |
| --- | --- | --- | ---: | ---: | ---: | ---: |
| `Make_Inertia` | `mj-spatial_kernels.adb:36` | [unproved_checks](logs/mj-spatial_kernels__make_inertia__adb_36.log) | 62 | 1 | 0 | 47.9 |
