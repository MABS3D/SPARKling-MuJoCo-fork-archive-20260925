#!/usr/bin/env python3
"""Build a checked probe that compares eager and lazy caches before each scenario."""
import argparse
import hashlib
import json
import os
