...
Source snapshot: `/tmp/sparkling-smooth-fragments-hd0iuira/source`

| Subprogram | Location | Result | Proof checks | Unproved/flow | Errors | Seconds |
| --- | --- | --- | ---: | ---: | ---: | ---: |
| `Integrate` | `mj-data-euler.adb:5` | [unproved_checks](logs/mj-data-euler__integrate__adb_5.log) | 55 | 1 | 0 | 95.8 |
