package body MJ.Poses with SPARK_Mode is
   ...
   procedure Transform_Any (R : out Vector_3; Position : Vector_3; Q : Quaternion; Point : Vector_3) with
   ...
   begin
      if Q (0) = 1.0 then
         Transform_Any (R, Position, [1.0, Q (1), Q (2), Q (3)], Point);
      else
         Transform_Any (R, Position, Q, Point);
      end if;
   end Transform;
